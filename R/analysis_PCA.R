...
#'
#' @param counts A numeric matrix or data frame containing count data (e.g., TMM or TPM values) with rows as features (e.g., genes)
...
#' @param shapekey An optional character string specifying the column name in \code{metadata} used to shape the points in the PCA plot.
